      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          {features.map((feature, index) => (
            <motion.div key={index} initial={{ y: 80, opacity: 0 }} whileInView={{ y: 0, opacity: 1 }} viewport={{ once: true, margin: '-100px' }} transition={{ duration: 0.8, delay: index * 0.15 }} className="bg-gray-50 rounded-3xl p-10 hover:bg-gray-100 transition-colors">
              <div className="mb-6 inline-flex p-4 rounded-2xl" style={{ backgroundColor: `${feature.accent}15` }}>
